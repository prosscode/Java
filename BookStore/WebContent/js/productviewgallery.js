    ...
    jQblvg.fn.elScroll = function(options) {
        ...
        var init = function() {
            ...
            // rail.css('margin-left','0px').css('width',(parseInt(step)+1)*elmax+'px');
							//	rail.css('margin-left','0px').css('width','200px');
            } else {
                ...
                rail.css('margin-left','0px').css('height','200px');
            }
...
//<div class="mousetrap" style="background-image: url(&quot;http://127.0.0.1:8020/site/js/blank.png&quot;); width: 340px; height: 340px; top: 0px; left: 0px; position: absolute; z-index: 9999; cursor: move;"></div>